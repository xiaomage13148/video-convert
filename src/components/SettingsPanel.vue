...
import { X, Cpu, HardDrive, Volume2, Trash2, Zap } from 'lucide-vue-next'
...
<template>
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fade-in" @click.self="emit('close')">
      ...
      <div class="mb-5">
        ...
        <div class="flex items-center justify-between p-3 bg-white/3 rounded-lg">
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            ...
            <div class="w-9 h-5 rounded-full bg-slate-600 peer-checked:bg-primary transition-colors duration-200 peer-focus:ring-2 peer-focus:ring-primary/30" />
            <div class="absolute left-0.5 top-0.5 w-4 h-4 bg-white rounded-full transition-transform duration-200 peer-checked:translate-x-4" />
          </label>
        </div>
      </div>
